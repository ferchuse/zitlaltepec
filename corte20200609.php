...
if($_POST['cmd']==0){
	...
	echo '<tr><td>Empresas</td><td><select name="empresas" id="empresas" multiple="multiple">';
	foreach($array_empresa as $k=>$v){
		echo '<option value="'.$k.'" selected>'.$v.'</option>';
	}
	echo '</select></td><th id="total_general"></th></tr>';
...
<Script language="javascript">
	...
	function buscarRegistros()
	{
		...
		if (objeto.readyState != 0) {
			...
			objeto.send("ajax=1&empresas="+$("#empresas").multipleSelect("getSelects")+"&usuarios="+$("#usuarios").multipleSelect("getSelects")+"&fecha_ini="+document.getElementById("fecha_ini").value+"&fecha_fin="+document.getElementById("fecha_fin").value+"&numeroPagina="+document.getElementById("numeroPagina").value+"&recaudacion="+document.getElementById("recaudacion").value+"&cveusuario="+document.getElementById("cveusuario").value+"&cvemenu="+document.getElementById("cvemenu").value);
			objeto.onreadystatechange = function()
			{
				if (objeto.readyState==4){
					var opciones2=objeto.responseText.split("|");
					document.getElementById("Resultados").innerHTML = opciones2[0];
					document.getElementById("total_general").innerHTML=opciones2[1];
					}
			}
		}
