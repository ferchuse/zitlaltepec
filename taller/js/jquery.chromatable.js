...
(function($){
    ...
    $.chromatable = {
		...
		return this.each(function(){
				...
				$(this).before($(this).clone().attr("id", "").addClass("_tfoot").css(
				...
				$('._tfoot').children('tbody').remove();
				$('._tfoot').children('thead').remove();
				...
				$("tfoot:eq(0)>tr th",this).each( function (i) {
																							 
					$("tfoot:eq(0)>tr th:eq("+i+")", $curr).width( $(this).width());
					
				});
				
				$("tfoot:eq(0)>tr td",this).each( function (i) {
																							 
					$("tfoot:eq(0)>tr td:eq("+i+")", $curr).width( $(this).width());
