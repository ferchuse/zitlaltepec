...
class Localizacion{
    ...
    public function estaImeiRegistrado(){
        $query = 'select estatus, plaza from movil_dispositivos where imei = :imei';
    ...
    function guardarUbicacion(){
        ...
        $query = 'insert into movil_localizacion(latitud, longitud, fecha, fecha_servidor, imei, id_geocerca, plaza) values(:latitud, :longitud, :fecha, :fecha_servidor, :imei, :id_geocerca, :plaza)';
        $pdo_statement = $this->pdo->prepare($query);
        ...
        $pdo_statement->bindParam(':fecha_servidor', $fecha_servidor, PDO::PARAM_STR);
        $pdo_statement->bindParam(':imei', $this->imei, PDO::PARAM_STR);
        $pdo_statement->bindParam(':id_geocerca', $this->id_geocerca, PDO::PARAM_INT);
        $pdo_statement->bindParam(':plaza', $this->plaza, PDO::PARAM_INT);
