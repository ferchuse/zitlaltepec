...
7=>"Facturacion",8=>"Auditoria",12=>"Direcci&oacute;n",11=>"Almacen",13=>"Mantenimiento",14=>"XML SAT",99=>"Administracion");//,10=>"Contabilidad"
//
	  ...
	  <tr>
		...
		<td width="62%">
		  <table cellpadding="0" cellspacing="0" width="100%" height="42" border="0" style="height: expression(parentElement.offsetHeight)">
			...
			<td width="100%" class="Titulo_Suscripciones"  bgcolor="#B6C5EE">VERIFICA DF '.$textoPlaza.'</td>
			</tr>
		  </table>
		</td>
  ...
  <table width="100%" cellpadding="0" cellspacing="0" border="0">
	  <tr>
	    <td class="menubackgr">		<div id="myMenuID"></div>';
			...
			echo 'var myMenu =';
			echo '[';
	        echo "	['icon', 'title', 'url', 'target', 'description'],  // a menu item
...
function top_r($SESSION,$enter=0) {
	...
	<table width="100%" height="50" border="0" cellpadding="0" cellspacing="0">
	  ...
	  <tr>
	   ...
	   <td background="images/bannertop-bg.gif"><span class="whiteText17">VERIFICA DF '.$textoPlaza.'</span></td>
